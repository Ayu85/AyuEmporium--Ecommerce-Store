...
const Whyus = () => {
    return (
        <div className='flex flex-col gap-10  flex-wrap items-center justify-center bg-[#FFF8F4] pt-20 py-4 px-14'>
            ...
            <div className='flex gap-5 items-center justify-center'><div className='flex group hover:bg-[#1C161A] hover:scale-105 transition-all hover:text-slate-200 cursor-pointer flex-col gap-2 items-center rounded-xl justify-center border-slate-600 border px-3 py-4 w-80 text-center '>
